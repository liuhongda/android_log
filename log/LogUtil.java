...
public class LogUtil {
    ...
    public static String saveUrl = Environment.getExternalStorageDirectory() + "/mydir/logs/app/";

    public static String testUrl = Environment.getExternalStorageDirectory() + "/mydir/logs/test/";
